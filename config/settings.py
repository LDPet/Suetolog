...
STT_PROVIDER = os.getenv("STT_PROVIDER", "yandex_speechkit")
YANDEX_STT_LANGUAGE = os.getenv("YANDEX_STT_LANGUAGE", "ru-RU")
YANDEX_STT_FORMAT = os.getenv("YANDEX_STT_FORMAT", "oggopus")
YANDEX_STT_TIMEOUT_SEC = int(os.getenv("YANDEX_STT_TIMEOUT_SEC", "30"))
