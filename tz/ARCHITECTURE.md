...
Актуальные ER-, service- и sequence-диаграммы находятся: [`ARCHITECTURE_ARTIFACTS.md`](ARCHITECTURE_ARTIFACTS.md); редактируемые Mermaid-исходники — в [`diagrams/`](diagrams/).
